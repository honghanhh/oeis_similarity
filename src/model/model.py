...
if '__main__' == __name__:
    ...
    parser.add_argument('-model', '--model', type=str, default = 'flax-sentence-embeddings/all_datasets_v3_roberta-large')
    ...
    X_s = model.encode(list(df_s['equation']))
    X_p = model.encode(list(df_p['premise']))
